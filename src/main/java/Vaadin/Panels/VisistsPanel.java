...
public class VisistsPanel extends Panel {
    ...
    public VisistsPanel(String caption) {
        super(caption);
        logger.debug(new Object(){}.getClass().getEnclosingConstructor().getName()+" : visitsPanel Constructor");
    ...
    public void init() {
        ...
        thread.start();
        logger.debug(new Object(){}.getClass().getEnclosingMethod().getName()+" : daemon started");
    }
    ...
    private class DaemonRefresh implements Runnable{
        ...
        public void run() {
            while(true) {
                ...
                logger.debug(new Object(){}.getClass().getEnclosingMethod().getName()+" : amount of visitors was gotten");
                try {
                    logger.debug(new Object(){}.getClass().getEnclosingMethod().getName()+" : sleep 5s");
                    Thread.sleep(5000);
