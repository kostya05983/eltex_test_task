...
public class MainHorizontalLayout extends HorizontalLayout {
    ...
    public MainHorizontalLayout(VaadinUI context) {
        ...
        logger.debug(new Object(){}.getClass().getEnclosingConstructor().getName()+" : create Weather Panel");
        addComponent(weatherPanel);
        weatherPanel.init();
        logger.debug(new Object(){}.getClass().getEnclosingConstructor().getName()+" : init WeatherPanel");

        exchangeRatesPanel = new ExchangeRatesPanel("Курсы валют",context);
        logger.debug(new Object(){}.getClass().getEnclosingConstructor().getName()+" : create exchangeRatesPanel");
        addComponent(exchangeRatesPanel);
        exchangeRatesPanel.init();
        logger.debug(new Object(){}.getClass().getEnclosingConstructor().getName()+" : init ExchangeRatesPanel");

        addComponent(visistsPanel);
        visistsPanel.init();
        logger.debug(new Object(){}.getClass().getEnclosingConstructor().getName()+" : init visits Panel");
    }
